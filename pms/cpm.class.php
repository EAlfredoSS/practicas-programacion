...
class cpm {
	...
	{	
		...
		//$sql="SELECT distinct (m.orden), m.nombre FROM mentor2009 m INNER JOIN couples2009antiguos c ON m.Email = c.id_1 WHERE c.id_2='".$this->useremail."' UNION SELECT distinct (m.orden), m.nombre FROM mentor2009 m INNER JOIN couples2009antiguos c ON m.Email = c.id_2 WHERE c.id_1='".$this->useremail."'";
		 ...
		 $sql="SELECT distinct (m.orden), m.nombre FROM mentor2009 m INNER JOIN couples2009antiguos c ON m.orden = c.user_id_1 WHERE c.user_id_2='".$this->userid."' UNION SELECT distinct (m.orden), m.nombre FROM mentor2009 m INNER JOIN couples2009antiguos c ON m.orden = c.user_id_2 WHERE c.user_id_1='".$this->userid."'";
