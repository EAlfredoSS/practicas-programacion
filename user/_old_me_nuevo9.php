                                ...
                                <div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
											...
											?> 
												<li>
															<center>
																<a href="../addlanguage/addlanguage.php?lang=<?php echo  "$idof"; ?>&use=know" title="" style="text-align:center;"> <img class="language language-<?php echo  $idof_2letras; ?> " />
								...
								<div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
											...
											?> 
												<li>
															<center>
																<a href="../addlanguage/addlanguage.php?lang=<?php echo  "$idof"; ?>&use=learn" title="" style="text-align:center;"> <img class="language language-<?php echo  $idof_2letras; ?> " />
