...
if( mysqli_num_rows($result1))
	{
        ...
        ?>
        <a style="background-color: #53d690; border: none; color: white; padding: 15px 32px; text-align: center; border-radius: 10px; text-decoration:none;" href="../trackerproposals/sent-studentcreateproposal.php?tid=<?php echo $identificador_contactado;?>">
        Request a session
    </a>
        <?php
...
?>
                                    <!-- Botón para activar el modal (ventana emergente) al hacer clic 
                                    <button class="btn btn-primary btn-lg launch-modal" data-toggle="modal" data-target="#myModal" style="background-color: #e65f00; border: none; color: white; padding: 15px 32px; text-align: center; border-radius: 10px;">
                                      Write a message
                                    </button>-->
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <form name="mensaje_usu" ENCTYPE="multipart/form-data" ACTION="<?php echo 'sndmsg.php?id_receptor=' . $id_del_receptor; ?>" METHOD="POST" id="formMensaje">
                                              ...
                                              <input type="submit" name="enviar" id="sendMessageBtn" class="btn btn-primary" style="background-color: rgb(141, 119, 103); border: none; color: white; padding: 15px 32px; text-align: center; border-radius: 10px;" value="Send message" disabled />
                                            </form>
                                          </div>
                                        </div><!-- /.modal-content -->
                                      </div><!-- /.modal-dialog -->
                            ...
                            <div class="top-profiles ">
                                <div class="pf-hd">
                                    <h3>Evaluations
                                        ...
                                        <p style="font-size: 16px"><a href="../infouser/evdonepartners.php?u=<?php echo "$identificador_usu_buscado";  ?>"    title=""><?php echo "$n_comentarios"; ?> evaluations received </a>
...
<script>
function checkInput() {
    // Obtener el campo de texto y el botón de envío
    var mensaje = document.getElementById("textareaID").value;
    var sendMessageBtn = document.getElementById("sendMessageBtn");

    // Si hay texto en el área de texto, habilitamos el botón y lo cambiamos a naranja
    if (mensaje.trim() !== "") {
...
document.getElementById("formMensaje").onsubmit = function(event) {
    var mensaje = document.getElementById("textareaID").value;

    // Si el campo de texto está vacío, mostramos el popup
    if (mensaje.trim() === "") {
