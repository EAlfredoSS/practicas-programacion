...
// Organización (solo si coincide con la del usuario logueado)
$org_name_display = '';
...
// ============================================================
// FUNCIONES AUXILIARES DE VISUAL
// ============================================================
...
function renderLevelDots($level)
{
    ...
    $level = min(7, $level);
    $colors = [
        1 => '#E10016', 2 => '#E10016', 3 => '#F14400', 4 => '#F14400',
        5 => '#FED700', 6 => '#1B9E00', 7 => '#1B9E00'
    ];
    $html = '<div class="level-dots">';
    for ($i = 1; $i <= 7; $i++) {
...
<head>
    ...
    <style>
        /* ── TOKEN DE MARCA — único: #e65f00 ── */
        a { color: #e65f00; }
        body { background-color: #eeeeee !important; }
        .fas, .far, .fal, .fab, .fa { color: #e65f00 !important; }

        /* ── HEADER (simplificado para perfil de otro usuario) ── */
        ...
        .header-home-link {
            ...
            margin-left: auto; padding: 0 6px; line-height: 1;
        }
        ...
        .user-data, .post-bar, .suggestions, .widget {
            ...
            border-left: 5px solid #e65f00 !important; background: white;
        }
        .username-dt {
        ...
        .u-btn-wrap {
            display: flex; flex-direction: column; align-items: center;
            gap: 10px; padding: 14px 12px 8px; width: 100%; box-sizing: border-box;
        }
        .u-action-btn {
            display: flex; align-items: center; justify-content: center; gap: 8px;
            width: 85%; padding: 10px 16px; border-radius: 8px; font-size: 13px;
            font-weight: 600; text-decoration: none; cursor: pointer; border: 2px solid;
            transition: all 0.2s; text-align: center; background: none;
        ...
        /* ── SKILL CARDS (idénticas a me.php) ── */
        .skill-tags {
        ...
        .skill-tags li .card-inner-wrapper {
            ...
            padding: 10px 6px 0 6px !important; box-sizing: border-box !important;
            border-radius: 12px !important; overflow: visible !important; cursor: default !important;
        }
        ...
        /* ── SUBIDIOMA (texto gris, sin fondo ni borde) ── */
        .sublang-text {
            position: absolute; top: 4px; left: 4px;
            font-size: 9px; font-weight: 500; color: #888888;
        ...
        /* ── BOTÓN "Ver evaluaciones" — naranja #e65f00 ── */
        .evaluation-compact .ev-link {
            display: flex; align-items: center; justify-content: center; gap: 8px;
            margin-top: 14px; font-size: 14px; font-weight: 700;
            color: #ffffff !important; text-decoration: none;
            border: 2px solid #e65f00; border-radius: 8px; padding: 12px 20px;
            background: #e65f00;
            transition: background 0.2s ease, box-shadow 0.2s ease, transform 0.15s ease;
            box-shadow: 0 3px 12px rgba(230,95,0,0.30);
        ...
        .ev-opts-open {
            ...
            color: #aaa !important; font-size: 18px !important; text-decoration: none !important;
        ...
        .form-control:focus { outline: none !important; border: 1px solid #e65f00 !important; box-shadow: 0 1px 8px #e65f00 !important; }
        .modal-body { position: relative; }
        #charCount { position: absolute; bottom: 20px; right: 40px; color: #aaa; font-size: 12px; margin: 0; }
...
<body>
                                    ...
                                    <div class="user-data full-width">
                                        <div class="user-profile">
                                            ...
                                            <div class="u-btn-wrap">
                                                ...
                                                <?php else: ?>
                                                    <button class="u-action-btn orange" data-toggle="modal" data-target="#myModal">
                                        ...
                                        <div class="job_descp">
                                            ...
                                            <ul class="skill-tags">
                                                <?php for ($iii = 0; $iii < count($my_langs_array); $iii++):
                                                    ...
                                                    $flag_is_placeholder = ($ruta_bandera === './images/placeholder.png');
                                                ...
                                                ?>
                                                    <li>
                                                        ...
                                                        <?php endif; ?>
                                                        <div class="card-inner-wrapper <?php echo $card_extra_class; ?>"
                                                            ...
                                                            <div class="info-icon-container">
                                                                ...
                                                                <span class="tooltip-box">
                                                                    ...
                                                                    <?php
                                                                    if ($is_sublanguage) echo 'Sublanguage of ' . htmlspecialchars($macrolang, ENT_QUOTES) . '. Click the parent flag to edit.';
                                                                    else echo htmlspecialchars($tooltip_ofr, ENT_QUOTES);
                                                                    ?>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="card-inner-wrapper <?php echo $card_extra_class; ?>"
                                                            ...
                                                            <div class="info-icon-container" style="margin-top:auto;">
                                                                ...
                                                                <span class="tooltip-box">
                                                                    ...
                                                                    <?php
                                                                    if ($is_sublanguage) echo 'Sublanguage of ' . htmlspecialchars($macrolang, ENT_QUOTES) . '. Click the parent flag to edit.';
                                                                    else echo htmlspecialchars($nivel_label, ENT_QUOTES);
                                                                    ?>
                                                                </span>
                                                            </div>
                                                            <div class="lang-price-spacer"></div>
                            ...
                            <div class="col-lg-3 pd-right-none no-pd">
                                <div class="right-sidebar">
                                    <div id="my_events" class="widget">
                                        ...
                                        <div class="jobs-list">
                                            <p style="color:#7f8c8d;font-size:13px;">Placeholder 1</p>
                                        </div>
                                    </div>
                                    ...
                                    <div id="events" class="widget">
                                        ...
                                        <div class="jobs-list">
                                            <p style="color:#7f8c8d;font-size:13px;">Placeholder 2</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <form name="mensaje_usu" enctype="multipart/form-data"
          action="./sndmsg.php?id_receptor=<?php echo $id_del_receptor; ?>" method="POST" id="formMensaje">
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">×</button>
                        <h4 class="modal-title">Friendship request and Direct message to user</h4>
                    </div>
                    <div class="modal-body" style="position:relative;">
                        <textarea rows="5" name="mensajedelusuario" maxlength="255" id="textareaID"
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" name="enviar" id="sendMessageBtn" class="btn btn-primary"
                            style="background-color:rgb(141,119,103);border:none;color:white;padding:7px 10px;"
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function() {
                        var popup = $('<div></div>').text('The bookmark has been added successfully!').css({
                            ...
                            'transform':'translate(-50%,-50%)','background-color':'green',
                            'color':'white','padding':'15px','border-radius':'5px',
                            'box-shadow':'0 0 10px rgba(0,0,0,.2)','font-size':'14px','z-index':'1000'
                        }).hide();
                        $('body').append(popup);
        ...
        function checkInput() {
            ...
            if (btn) {
                ...
                btn.style.backgroundColor = ta.value.trim() ? '#e65f00' : 'rgb(141,119,103)';
            }
        }
