...
//mirar que no este el nick repetido
							...
							?>
                                ...
                                <div class="user-specs ">
                                    <h3><?php
										...
										<span><?php echo "#$identificador_usu_buscado"; ?></span><br><br>
...
*/
		...
		data-url="../bookmarks/addbookmark.php?idfav=<?php echo $identificador_contactado; ?>" > Add to bookmarks </a> <br>	
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script>
    $(".launch-modal").on("click", function() {
        var url = $(this).data("url"); // Obtiene la URL de data-url
        $.ajax({
            url: url,
            method: "GET", 
            success: function(response) {
                // Mostrar el pop-up verde tras la acción
                var popup = $("<div></div>")
                                ...
                                <div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
											...
											?> 
												<li>
															<center>
                                                                   <a href="#" title="" style="text-align:center;">
                                                                    <?php
                                                                        // Flag image with fallback to placeholder if not found
                                                                        $bandera_path = "./images/banderasseparadas2024/{$idof_2letras}.png";
                                                                        if (!file_exists($bandera_path)) {
                                                                            $bandera_path = "./images/placeholder.png";
                                                                        }
                                                                    ?>
                                                                    <img src="<?php echo $bandera_path; ?>" alt="<?php echo htmlspecialchars($idof, ENT_QUOTES); ?> flag" style="width:50px;height:33px;" />
