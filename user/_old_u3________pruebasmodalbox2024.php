...
<head>
	...
	<!-- esto es lo del modal box para enviar mensajes que salte el text area al frente -->
	
	
	
	<!-- saved from url=(0043)https://fiddle.jshell.net/WV5e7/show/light/ -->

  
  <script type="text/javascript" src="./css_modalboxtextarea/jquery-git.js.descarga"></script>

    <link rel="stylesheet" type="text/css" href="./css_modalboxtextarea/result-light.css">

      <link rel="stylesheet" type="text/css" href="./css_modalboxtextarea/bootstrap.min.css">
      <script type="text/javascript" src="./css_modalboxtextarea/bootstrap.min.js.descarga"></script>
  ...
  <script id="insert"></script>
	...
	<!-- FIN  esto es lo del modal box para enviar mensajes que salte el text area al frente -->
...
<button class="btn btn-primary btn-lg launch-modal" data-toggle="modal" data-target="#Modal_sendmessage" style="background-color: #e65f00;  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  border-radius: 10px;
...
<!-- Modal -->
<div class="modal fade" id="Modal_sendmessage" tabindex="-1" role="dialog" aria-labelledby="Modal_sendmessageLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title" id="Modal_sendmessageLabel">Direct message to user</h4>
      </div>
      <div class="modal-body">
		<textarea rows="5" cols="20" wrap="soft" name="mensajedelusuario" maxlength="255" id="textareaID" class="form-control" > </textarea>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit" name="enviar" value="Send message" style="background-color: #e65f00; border-color: #e65f00; ">Send</button> 
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<!-- esto del modal box que al pulsar send message abre un text area en primer plano  -->


    <script type="text/javascript">//<![CDATA[


$('#Modal_sendmessage').on('shown.bs.modal', function () {
    $('#textareaID').focus();
})
...
<!-- FIN esto del modal box que al pulsar send message abre un text area en primer plano  -->
