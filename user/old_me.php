                    ...
                    <div class="main-left-sidebar no-margin">
                        <div class="user-data full-width ">
                            <div class="user-profile">
                                ...
                                ?> <!-- <p style="color: #2e8b57; font-size:80%;">**I'm a professional teacher**</p> --> <?php /*  <i class="fa fa-star" style="font-size:80%;"></i>*/ // } 
                                                                                                                                                                ?>
                                ...
                                <div class="user-specs ">
                                    ...
                                    <!-- <span><?php // echo "User no.:$identificador2017"; 
                                                ?></span><br><br> -->
                                    ...
                                    <span><?php
                                            ...
                                            echo "<br>(Local time: $horaFormateada2)";
                        ...
                        <div class="suggestions full-width">
                            ...
                            <div class="suggestions-list">
                                <div class="suggestion-usd">
                                    ...
                                    <!--<span><a href="<?php // echo "../user/u.php?dst=$distancia99&identificador=$orden99"; 
                                                        ?>" ><i class="la la-chevron-right"></i></a></span>  -->
                            ...
                            <div id="seccion_teach" class="post-bar">
                                ...
                                <div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
                                        ...
                                        ?>
                                            <li <?php if ($my_langs_level_array[$iii] == 0) {
                                        ...
                                        for ($iii = 0; $iii < count($my_langs_level_array); $iii++) {
                                            ...
                                            if ($my_langs_level_array[$iii] == 0) { ?>
                                                ...
                                                <div class="alerta alerta-9" ; style=" border: 1px solid red; background-color: transparent; ">
                                ...
                                <div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
                                        ...
                                        ?>
                                            <li <?php if ($learn_langs_level_array[$iii] == 0) {
                                                    echo "style=\" border: 1px solid red; \" ";
                                                } ?>>
                                                <center>
                                                    <a
                ...
                <div class="col-lg-3 pd-right-none no-pd ">
                                    ...
                                    ?>
                                        ...
                                        <div class="job-details sgt-text suggestion-usd">
                                            ...
                                            <p> <?php echo $fecha1 . "(" . $dayOfWeek_corto . ")";  ?>
                                                ...
                                                <span style="font-size: 80%; "> <?php if (!$ev_broadcasted) {
                                                                                    echo "<a href=\"../events/radaruserevent.php?evid=$id_event1\">Promote</a> · ";
                                                                                }     ?>

                                                    <?php if (is_null($es_replica_ev)) {
                                                        echo "<a href=\"../events/makerecurrentshowinfo.php?idev=$id_event1\">Make weekly</a> · ";
                                                    }    ?>
                    ...
                    <div class="widget widget-jobs">
                        ...
                        <div class="jobs-list">
                            ...
                            <div class="view-more">
                                <a href="../testingprototypes/mostviewedjobs.php" title="">Apply now!</a>
                            </div>
                    ...
                    <div class="widget widget-jobs">
                        ...
                        <div class="jobs-list">
                            ...
                            <!--job-info end-->
                            <div class="view-more">
                                <a href="../testingprototypes/publishjob.php" title="">Publish now!</a>
                            </div>
