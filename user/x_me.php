...
function getFlagPath($code2, $code3) {
    ...
    // Placeholders en orden de preferencia - AHORA CON TU RUTA
    $placeholders = [
        'user/images/banderasseparadas2024/placeholder.png',
    ...
    if ($placeholder === '') $placeholder = '../images/banderasseparadas2024/placeholder.png';
...
<head>
    ...
    <style>
        ...
        /* ALERTA DE ACCIÓN */
        .alerta-9 {
            background: rgba(236,236,236,1); color: #b2b2b2; padding: 8px 12px !important;
            font-size: 11px !important; display: flex; align-items: center; gap: 8px; font-weight: 500;
            border-radius: 20px; width: 100%; border: 1px solid #e65f00; margin-top: 10px !important;
        }
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="https://www.languageexchanges.com/bookmarks/friends.php" title="">Friends</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="../pms" title="">
                                    ...
                                    <div class="user-data full-width">
                                        <div class="user-profile">
                                            ...
                                            <div class="user-specs">
                                                ...
                                                <?php } ?>
                                                <span><i class="fas fa-clock"></i> <?php echo "$horaFormateada2 ($zonaHoraria)"; ?></span>
                                                <?php
                                                $domain1 = substr($email_del_usu, (int) strpos($email_del_usu, '@') + 1);
                                ...
                                <div class="posts-section">
                                    <div id="seccion_teach" class="post-bar">
                                        ...
                                        <div class="job_descp">
                                            ...
                                            <ul class="skill-tags">
                                                ...
                                                for ($iii = 0; $iii < count($my_langs_array); $iii++):
                                                    ...
                                                    if ($necesita_accion) $mostrar_alerta_my = true;

                                                    // Obtener ruta de bandera
                                                    ...
                                                    $flag_is_placeholder = ($ruta_bandera === './images/banderasseparadas2024/placeholder.png' || strpos($ruta_bandera, 'placeholder') !== false);
                                            ...
                                            <?php if ($mostrar_alerta_my): ?>
                                                <div class="alerta-9">(*) Click on the flags to add more information about your languages.</div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="job_descp">
                                            ...
                                            <ul class="skill-tags">
                                                <?php
                                                $mostrar_alerta_learn = false;
                                                for ($iii = 0; $iii < count($learn_langs_array); $iii++):
                                                    ...
                                                    if ($necesita_accion) $mostrar_alerta_learn = true;
                                ...
                                <div class="suggestions full-width" style="margin-top:20px;">
                                    ...
                                    <div class="suggestions-list">
                                        <?php if ($n_comentarios > 0): ?>
                                            ...
                                            <?php if ($num_evaluaciones > $num_max_ev_mostradas): ?>
                                                <div class="view-more" style="margin-top:15px;">
                                                    <a href="../infouser/evdone.php">View all evaluations</a>
                                                </div>
                                            <?php endif; ?>
