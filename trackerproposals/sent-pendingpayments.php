<?php 
session_start();
//$mi_identificador=$_SESSION['orden2017'];    //esto lo cogeremos del require listofqueries
...
//$tiempo_corte=time();     // esto lo ponemos en el require de listofqueries
...
$query = $QUERY_STUDENT_PENDING_PAYMENTS;  //extraido del require de listofqueries
//die($query);
$result = mysqli_query($link, $query);
$n_payments_pending = mysqli_num_rows($result);
...
<head>
    ...
    <style>
        ...
        /* Icono libro en vez de estrella */
        .student-badge {
            position: absolute;
            bottom: 0; right: -5px;
            color: #f1c40f;
        ...
        @media (max-width: 768px) {
            ...
            .btn-pay-all { width: 100%; justify-content: center; }
        }
    </style>
</head>
<body>
            ...
            <div class="forum-questions-sec" style="width:100%">
                ...
                if (!$n_payments_pending) {
                    echo '<div class="empty-state">
                            ...
                            <h3>No pending payments at the moment</h3>
                          </div>';
                ...
                <div style="text-align: center;">
                    <a href="./studentprepaymentmultiple.php" class="btn-pay-all">
                        <i class="fas fa-shopping-cart"></i> Pay all pending classes
                    </a>
                </div>
                        ...
                        <div class="card-right-content">
                            ...
                            <div class="action-buttons">
                                <div class="action-left">
                                    <a class="btn-accept" href="./studentprepayment.php?trackid=<?php echo $id_of_class; ?>">
                                        <i class="fas fa-credit-card"></i> Proceed to Payment
                                    </a>
                                    <a class="btn-decline btn-denegar" data-url="./studentcancel.php?trackid=<?php echo $id_of_class; ?>&action=1">
...
<!-- Notificación para cancelación -->
<div id="notification-decline" class="notification decline"></div>
