...
$query="SELECT * FROM tracker WHERE id_user_teacher = '$mi_identificador' AND paid=1 AND releasefunds=1 AND moneywithdrawnbyteacher=0 ORDER BY start_time_unix ASC ";
...
$nuevos=mysqli_num_rows($result);
 ...
 if (!$nuevos)
        echo " No money in the wallet at this moment.";
