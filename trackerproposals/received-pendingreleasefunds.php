<?php
session_start();
//$mi_identificador=$_SESSION['orden2017'];   //	recogido en require list of queries
...
// Consulta principal: lecciones pasadas con fondos por liberar
$query = $QUERY_TEACHER_PENDING_RELEASE_FUNDS_VALIDATION;
$result = mysqli_query($link, $query);
$n_liberar_fondos = mysqli_num_rows($result);
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <style>
        ...
        /* ── BOTÓN PRINCIPAL (View Details) NARANJA ── */
        .btn {
            border: 2px solid #d35400 !important;
            background: #d35400;
            padding: 10px 20px;
