...
$class_id = openssl_decrypt(base64_decode($list_encoded_class), 'AES-256-CBC', getenv('AES_256_KEY'));
$total_amount = openssl_decrypt(base64_decode($encoded_amount), 'AES-256-CBC', getenv('AES_256_KEY')); 
