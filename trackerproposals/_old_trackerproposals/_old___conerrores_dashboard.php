...
$query_teacher_active = "SELECT count(t.id_tracking) FROM tracker t 
    ...
    AND t.proposal_accepted_teacher = 2 AND t.cancelled = 0 AND t.end_time_unix > $tiempoUnix";
...
$query_teacher_proposals = "SELECT count(id_tracking) FROM tracker 
    WHERE id_user_teacher = '$mi_identificador' 
    AND proposal_accepted_teacher = 0 AND cancelled = 0 AND start_time_unix > $tiempoUnix";
...
/*
$query_teacher_releases = "SELECT count(id_tracking) FROM tracker 
    WHERE id_user_teacher = '$mi_identificador' 
    AND proposal_accepted_teacher = 2 AND cancelled = 0 AND paid = 1 
    AND releasefunds = 0 AND start_time_unix <= $tiempoUnix";
*/
	
$query_teacher_releases = "
SELECT count(id_tracking)
FROM tracker t
...
$query_student_active = "SELECT count(t.id_tracking) FROM tracker t 
    ...
    AND t.proposal_accepted_teacher = 2 AND t.cancelled = 0 AND t.paid = 1 AND t.end_time_unix > $tiempoUnix";
...
$query_student_payments = "SELECT count(id_tracking) FROM tracker 
    WHERE id_user_student = '$mi_identificador' 
    AND proposal_accepted_teacher = 2 AND cancelled = 0 AND paid = 0 AND start_time_unix >= $tiempoUnix";
...
$query_student_releases = "SELECT count(t.id_tracking) FROM tracker t 
    WHERE t.id_user_student = '$mi_identificador' 
    AND t.proposal_accepted_teacher = 2 AND t.cancelled = 0 AND t.paid = 1 AND t.releasefunds = 0 AND t.end_time_unix < $tiempoUnix";
