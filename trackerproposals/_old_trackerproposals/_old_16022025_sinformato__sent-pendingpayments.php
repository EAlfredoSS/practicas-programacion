...
// AND cancelled=0 ???
$query="SELECT * FROM tracker WHERE id_user_student ='" . $mi_identificador . "'  AND proposal_accepted_teacher=2 AND cancelled=0 AND paid=0 AND $tiempo_corte<=start_time_unix ORDER BY start_time_unix ASC ";
