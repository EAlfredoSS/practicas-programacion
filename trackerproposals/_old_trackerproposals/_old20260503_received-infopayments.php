...
$query22 = "SELECT * FROM tracker WHERE id_user_teacher = '$mi_identificador' AND paid=1 AND releasefunds=1 AND moneywithdrawnbyteacher=1 ORDER BY start_time_unix ASC";
                    ...
                    <div class="forum-questions">
                        ...
                        if (!$nuevos22) {
                            ...
                            while ($fila = mysqli_fetch_array($result22)) {
                                ...
                                $icono = $cancelado ? 'fa-ban' : 'fa-check';
