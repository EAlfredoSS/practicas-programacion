...
display: block; /* Quita el flex */
    ...
    background-color: #e77667 !important;
}
                ...
                <div class="forum-links">
					...
					*/
					?>
                        ...
                        <li><a href="./sent-pastclasses.php" title="">Payment releases pending (<?php echo $n_release_payment_pending; ?>)</a></li>
        ...
        <section class="forum-page">
            <div class="container">
                <div class="forum-questions-sec" style="width: 100%">
					...
					<button class="button-studentprepaymentmultiple"><a href="./studentprepaymentmultiple.php">Proceed to payment multiple classes at once</a></button>
	</br></br>
...
<?php
							...
							?>
							<ul class="quest-tags">
								<li><a class="btn-aceptar" style="background-color:#53d690;" href="./studentprepayment.php?trackid=<?php echo "$id_of_class"; ?>&action=2" >Pagar</a></li>
								<li><a class="btn-denegar" style="background-color: #e77667;" data-url="./studentcancel.php?trackid=<?php echo "$id_of_class"; ?>&action=1">Declinar</a></li>
							</ul>
						<?php
...
<div class="tooltip-container" style="color:#b2b2b2; margin: -10px 0 0 0; align: center;">
	...
	<script>
// Nueva funcionalidad para botón Declinar
