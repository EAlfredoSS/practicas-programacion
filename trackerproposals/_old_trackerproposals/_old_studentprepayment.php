...
$encoded_class = base64_encode(openssl_encrypt($id_of_class, 'AES-256-CBC', getenv('AES_256_KEY')));
$encoded_amount = base64_encode(openssl_encrypt($total_price, 'AES-256-CBC', getenv('AES_256_KEY')));
