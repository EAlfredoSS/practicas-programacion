...
$encoded_classes = base64_encode(openssl_encrypt($list_classes_to_encode, 'AES-256-CBC', getenv('AES_256_KEY')));
$encoded_total_amount = base64_encode(openssl_encrypt($amount_of_classes_pending_of_payment, 'AES-256-CBC', getenv('AES_256_KEY')));
...
$itemid1 = base64_encode(openssl_encrypt($itemid1, 'AES-256-CBC', getenv('AES_256_KEY')));
$itemname1 = base64_encode(openssl_encrypt($itemname1, 'AES-256-CBC', getenv('AES_256_KEY')));
$productname1 = base64_encode(openssl_encrypt($productname1, 'AES-256-CBC', getenv('AES_256_KEY')));
$itemdescription1 = base64_encode(openssl_encrypt($itemdescription1, 'AES-256-CBC', getenv('AES_256_KEY')));
$internalcodename1 = base64_encode(openssl_encrypt($internalcodename1, 'AES-256-CBC', getenv('AES_256_KEY')));
$amountprice1 = base64_encode(openssl_encrypt($amountprice1, 'AES-256-CBC', getenv('AES_256_KEY')));
