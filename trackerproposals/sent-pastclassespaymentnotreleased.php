...
session_start();
//$mi_identificador=$_SESSION['orden2017']; //varible en require de listofqueries
...
//$tiempo_corte=time();   // ya introducido en require listofqueries
...
$query =	$QUERY_STUDENT_PAST_LESSONS_PENDING_VALIDATION;
$result = mysqli_query($link, $query);
$n_release_payment_pending = mysqli_num_rows($result);

/*

$query109 = "SELECT * FROM tracker t WHERE t.id_user_student ='".$mi_identificador."' AND proposal_accepted_teacher=2 AND cancelled=0 AND paid=1 AND end_time_unix>$tiempo_corte";
...
<head>
    ...
    <title>Payment releases pending</title>
    ...
    <style>
        ...
        /* Icono libro (distintivo estudiante) */
        .student-badge {
            position: absolute;
            bottom: 0; right: -5px;
            color: #f1c40f;
        ...
        .notification.show { opacity: 1; transform: translateY(0); display: block; }
    ...
    <section class="forum-page">
        <div class="container">
            <div class="forum-questions-sec" style="width:100%">
                ...
                <?php
                if (!$n_release_payment_pending) {
                    echo '<div class="empty-state">
                            <div class="empty-state-icon"><i class="fas fa-hand-holding-usd"></i></div>
                            <h3>No pending fund releases at the moment</h3>
                          </div>';
                ...
                while ($fila = mysqli_fetch_array($result)) {
                    ...
                    $status_text  = "AWAITING RELEASE";
                    $status_class = "status-release-pending";
                    ?>
                        ...
                        <div class="card-right-content">
                            ...
                            <div class="action-buttons">
                                <div class="action-left">
                                    <a class="btn-release btn-denegar" data-url="./studentreleasefunds.php?trackid=<?php echo $id_of_class; ?>">
                                        <i class="fas fa-check-circle"></i> Release Funds
                                    </a>
                                    <a class="btn-ticket" href="./openaticket.php">
                                        <i class="fas fa-exclamation-triangle"></i> Report Issue
                                    </a>
                                </div>
                                <div class="action-right">
                                    <button class="btn-details class-name" data-id="<?php echo $id_of_class; ?>">
...
<!-- Notificación para liberación de fondos -->
<div id="notification-decline" class="notification"></div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.btn-denegar').forEach(function(button) {
            button.addEventListener('click', function(e) {
                ...
                notification.textContent = 'Funds released correctly for this lesson!';
