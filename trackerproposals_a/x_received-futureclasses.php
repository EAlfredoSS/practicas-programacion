...
// Contadores para las pestañas (aunque no se muestren, se mantienen por si se usan en otros archivos)
...
$query110 = "SELECT * FROM tracker WHERE id_user_teacher = " . intval($mi_identificador) . " AND proposal_accepted_teacher = 2 AND cancelled = 0 AND paid = 1 AND releasefunds = 0 AND start_time_unix <= $tiempoUnix";
                ...
                <div class="forum-questions-sec" style="width: 100%">
                    <div class="forum-questions">
                        ...
                        while ($fila = mysqli_fetch_array($result)) {
                            ...
                            $nombre_idioma = '';
                            $common_langs_badges = []; // Badges de idiomas comunes con nivel
