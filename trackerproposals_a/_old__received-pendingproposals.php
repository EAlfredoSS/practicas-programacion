            ...
            <div class="container">
				<div class="forum-links">
    				<ul>
        				...
        				<li class="active"><a href="./received-pendingproposals.php" title="">Received proposals as teacher</a></li>
...
.forum-links ul {
    ...
    padding: 0;
    margin: 0;
    padding-left: 390px; /* Espacio desde el borde izquierdo del contenedor */
}
