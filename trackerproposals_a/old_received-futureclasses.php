...
/*
if (!$nuevos) {
    echo "No sessions for this user yet";
...
<style>
/* CSS copied and adapted from received-pendingproposals.php for consistency */
                    ...
                    <div class="forum-questions">
                        ...
                        while ($fila = mysqli_fetch_array($result)) {
							...
							*/
                            ...
                            $status_class = "status-pending"; // default yellow
                            ...
                            echo "<div class=\"proposal-card\">";
                                ...
                                echo "<div class=\"card-middle\">";
                                    ...
                                    // Detail hidden block (Moved logic here)
                                ...
                                echo "<div class=\"card-right\">";
                                    ...
                                    echo "<button class=\"btn class-name\" data-id=\"$id_of_class\">View Details</button>";
                                echo "</div>";
