...
$n_release_payment_pending=$nuevos;
...
<body>
                ...
                <div class="forum-links">
					...
					*/
					...
					?>
                        ...
                        <li ><a href="./sent-pendingpayments.php" title="">Lessons payment pending (<?php echo $n_payments_pending; ?>)</a></li>
                        <li class="active"><a href="#"  title="">Payment releases pending (<?php echo $n_release_payment_pending; ?>)</a></li>
        ...
        <section class="forum-page">
            <div class="container">
                <div class="forum-questions-sec" style="width: 100%">
					...
					<?php	if (!$n_release_payment_pending) 
  ...
  <button class="button-studentprepaymentmultiple">
    <a href="./studentprepaymentmultiple.php">Pay all pending classes at one</a>
  </button>
</div>
	</br></br>
...
<?php
							...
							<?php //nombre de los botones heredados de paginas anteriores, no prestar atencion ?>
								<li><a class="btn-denegar" style="background-color: #53d690;" data-url="./studentreleasefunds.php?trackid=<?php echo "$id_of_class"; ?>">Lesson was successful (release funds to teacher)</a></li>
								<li><a class="btn-aceptar" style="background-color:#e77667;" href="./openaticket.php" >The lesson was not successful</a></li>
