...
/* On site */
.post_comment_sec form button, .input-proposed, #language_to_learn {
    color: #ffffff;
    font-size: 14px;
  ...
  <div class="post-comment-box">
								...
								<div class="user-poster">
									...
									<div class="post_comment_sec">
										<form>
											<textarea id="textareaID" placeholder="I want to practice conditional sentences..."></textarea>
...
<script> // Script para la comporvacion del formulario
$(document).ready(function() {
    ...
    $("input[name='submit1']").on("click", function(event) {
        ...
        if (startDate === "" || startTime === "" || duration === "" || description === "" || language === "") {
        ...
        $("#class-form").hide();  // Aquí cambiamos para que solo se oculte el formulario principal

        // Asegurarnos de que los contenedores que no quieres ocultar sigan visibles
        $(".post-comment-box").show(); // Mantenemos visibles los contenedores de comentario
    });
