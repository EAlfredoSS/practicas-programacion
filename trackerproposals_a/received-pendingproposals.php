...
<head>
    ...
    <title>Received Proposals - Teacher Dashboard</title>
                    ...
                    <div class="forum-questions">
                        <?php
                            ...
                            while ($fila = mysqli_fetch_array($result)) {
                                ...
                                {
                                    case 0: $level_language_to_teach_2='Level unknown'; break;
                                    case 1: $level_language_to_teach_2='Beginner'; break;
                                    case 2: $level_language_to_teach_2='A1'; break;
                                    case 3: $level_language_to_teach_2='A2'; break;
                                    case 4: $level_language_to_teach_2='B1'; break;
                                    case 5: $level_language_to_teach_2='B2'; break;
                                    case 6: $level_language_to_teach_2='C1'; break;
                                    case 7: $level_language_to_teach_2='C2'; break;
                                }
                                ...
                                echo "<div class=\"proposal-card\">";
                                    ...
                                    echo "<div class=\"card-left\">";
                                        ...
                                        echo "</div>";
                                        echo "<div class=\"status-badge status-pending\">PENDING</div>";
                                    echo "</div>";
                                    ...
                                    echo "<div class=\"card-middle\">";
                                        ...
                                        echo "<div class=\"class-details\" id=\"details-class$id_of_class\">";
                                            ...
                                            if($session_paid==0) echo "<span style='color:orange'>Waiting for student deposit</span><br>";
                                            elseif($session_releasefunds==0) echo "<span style='color:green'>Student made deposit</span><br>";
                                            echo "</p>";
                                        echo "</div>";
    ...
    <script type="text/javascript">
        ...
        btnAceptars.forEach(function(btnAceptar) {
            btnAceptar.addEventListener('click', function(event) {
                ...
                const url = btnAceptar.getAttribute('data-url');
        ...
        btnDenegars.forEach(function(btnDenegar) {
            btnDenegar.addEventListener('click', function(event) {
                ...
                const url = btnDenegar.getAttribute('data-url');
