...
//echo "<br><br><br><br><br>$query<br><br><br><br>";
...
<head>
    ...
    <title>Pending fund releases</title>
							...
							echo "<div class=\"proposal-card\">";
								...
								echo "<div class=\"card-left\">";
									echo "<div class=\"avatar-circle\">";
										echo "<a href=\"../user/u.php?identificador=$id_student\"><img src=\"$path_photo\" alt=\"Student\" style=\"width:100%; height:100%; border-radius:50%; object-fit:cover;\"></a>";
										echo "<i class=\"fas fa-star star-badge\"></i>";
									echo "</div>";
                                    // Status Badge logic
                                    if($session_paid==0) echo "<span class=\"pending-status\" style=\"background:#ecf0f1; color:#7f8c8d;\">UNPAID</span>";
                                    elseif($session_releasefunds==0) echo "<span class=\"pending-status\" style=\"background:#d5f5e3; color:#27ae60;\">PAID</span>";
								echo "</div>";
								...
								echo "<div class=\"card-middle\">";
									...
									echo "<div class=\"class-details\" id=\"details-class$id_of_class\" style=\"display:none; margin-top:15px;\">";
										 ...
										 echo "</p>";
										 if($session_paid==0) echo "<p style='color:orange'>Waiting for student to make deposit</p>";
										 elseif($session_releasefunds==0) echo "<p style='color:green'>Student made the deposit. Waiting for release.</p>";
									echo "</div>";
