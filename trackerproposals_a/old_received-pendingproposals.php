...
// Contamos cuÃ¡ntos resultados hay
...
.tooltip-container {
  position: relative; /*relative: los elementos se posicionan de forma relativa a su posiciÃ³n normal.*/
...
.forum-links ul li.active a::after {
    ...
    right: 0;
    height: 2px;
    background-color: #e65f00; /* LÃ­nea roja debajo del enlace activo */
}
...
<body>
                ...
                <div class="forum-questions-sec" style="width: 100%">
                    <div class="forum-questions">
                        <?php
							...
							//aquÃ­ sacamos las lenguas del profe
                        ...
                        while ($fila = mysqli_fetch_array($result)) {
							...
							*/
							...
							//aquÃ­ sacamos las lenguas del alumno
							...
							//con esta lÃ­nea lo que hacemos es borrar los valores vacÃ­os y reorganizar el array
    ...
    <script type="text/javascript">
		...
		// Si no existe, la creamos dinÃ¡micamente
		if (!notification) {
		...
		// Procesar cada botÃ³n de "Aceptar"
		btnAceptars.forEach(function(btnAceptar) {
        	btnAceptar.addEventListener('click', function(event) {
        	    event.preventDefault(); // Prevenir que el enlace realice la acciÃ³n de navegaciÃ³n
        	    console.log('BotÃ³n Aceptar presionado'); 
		...
		btnDenegars.forEach(function(btnDenegar) {
    	    btnDenegar.addEventListener('click', function(event) {
    	        ...
    	        // Mostrar la notificaciÃ³n (puedes personalizar el mensaje)
