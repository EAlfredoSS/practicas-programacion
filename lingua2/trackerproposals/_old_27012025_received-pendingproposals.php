...
for($i=0;$i<$nuevos;$i++)
{
    ...
    <div class="usr-question">
        ...
        <div class="usr_quest">
            <h3 class="class-name" data-id="class<?php echo $id_of_class; ?>"><?php echo $language_to_teach?> <?php echo $id_of_class; ?></h3>
            ...
            <ul class="quest-tags"> <!-- href="./teacheracceptdecline.php?trackid=  // href="./teacheracceptdecline.php?trackid=  -->
				<li><a class="accept-button" style="background-color: #53d690;=<?php echo "$id_of_class"; ?>&action=2">Accept</a></li>
				<li><a class="decline-button" style="background-color: #e77667;=<?php echo "$id_of_class"; ?>&action=1">Decline</a></li>
			</ul>
...
<script>
        document.addEventListener('DOMContentLoaded', function () {
			...
			document.querySelectorAll('.accept-button, .decline-button').forEach(function(button) {
    			button.addEventListener('click', function(event) {
        		event.preventDefault();

        		const questTags = button.closest('ul');

        		if (button.classList.contains('accept-button')) {
            		questTags.innerHTML = '<li><a href="#" style="width: 260%; text-align: center; background-color: #53d690;">Paid</a></li>';
            		console.log("Botón aceptado");
        		} else if (button.classList.contains('decline-button')) {
            		questTags.innerHTML = '<li><a href="#" style="width: 110%; text-align: center; background-color: #e77667;">Decline</a></li>';
           			console.log("Botón declinado");
        		}
				});
...
<!-- Cierre de etiquetas del cuerpo y el documento -->
</body>
</html>