...
WHERE t.id_user_student ='" . $mi_identificador . "'  AND proposal_accepted_teacher=2 AND cancelled=0 AND paid=1  AND end_time_unix>$tiempoUnix
        ...
        <section class="forum-sec">
            <div class="container">
                <div class="forum-links">
                    <ul>
                        <li class="active"><a href="./sent-futureclasses.php" title="">Next lessons as student (<?php echo $n_next_lessons; ?>)</a></li>
                        <li><a href="./sent-pendingpayments.php" title="">Lessons payment pending (<?php echo $n_received_proposals; ?>)</a></li>
                        <li><a href="./sent-pastclasses.php" title="">Past lessons as student (<?php echo $n_past_lessons; ?>)</a></li>
                    </ul>
                </div>
            </div>
        </section>
