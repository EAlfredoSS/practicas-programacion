...
/* Mensaje sin resultados - UNIFICADO */
.empty-state {
    background: white;
    border-radius: 12px;
                    ...
                    <div class="forum-questions">
                        <?php
                            ...
                            while ($fila = mysqli_fetch_array($result)) {
                                ...
                                // CARD HTML - ESTRUCTURA UNIFICADA
