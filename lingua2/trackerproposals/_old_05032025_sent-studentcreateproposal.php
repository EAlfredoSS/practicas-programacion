...
<h3>Make a meeting proposal to your partner</h3>
  ...
  <br>
	<img src="<?php echo "$path_photo"; ?>" alt="" />
	<br><br>
	<br><br>
	...
	This teacher offers the following languages. Which one would you like to practice with him/ her?<br>
	<br>
  ...
  <br><br>
    ...
    <label for="start_date">Starting local date (<?php echo $my_timeshift; ?>) <i style="color:#b2b2b2; font-size:20px;" class="fas fa-info-circle"></i> :</label> <br><br>
    <input type="text" id="start_date" name="start_date" required><br><br>
    <label for="start_time">Starting local time (<?php echo $my_timeshift; ?>) <i style="color:#b2b2b2; font-size:20px;" class="fas fa-info-circle"></i> :</label> <br><br>
	...
	else
	{
		...
		$query333="
			...
			{	
					...
					echo "Type of meeting: $type_of_meeting<br><br>";
  ...
  <div class="post-comment-box">
	Topics that you would like to practice in this lesson <br> <br>
  ...
  // Cuando el usuario hace clic en "See proposed classes"
	$("input[name='submit1']").on("click", function(event) {
	    ...
	    var previewContent = `
	      ...
	      <li><strong>Duración de cada clase:</strong> ${duration} minutos</li>
	      <li><strong>Descripción:</strong> ${description}</li><br>
	      <li><strong>Clases programadas:</strong></li>
	    `;
	    ...
	    for (var i = 0; i < repetitions; i++) {
	        ...
	        previewContent += `
	        <li>
	            <strong>Clase ${i + 1}:</strong> ${formattedDate} de ${displayStartHour}:${String(startMinute).padStart(2, "0")} ${startAMPM} 
