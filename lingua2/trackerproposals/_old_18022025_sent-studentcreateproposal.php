...
$(document).ready(function() {
	...
	$("#confirm-submit, #cancel-submit").on("click", function() {
	    if ($(this).attr("id") === "confirm-submit") {
	        // Si el usuario confirma, ocultar previsualización y agregar input oculto
	        ...
	        // Enviar el formulario de manera segura
	        document.getElementById("class-form").submit();
	    } else {
	        // Si el usuario cancela, volver a mostrar el formulario y el botón
	        $("#preview-container").hide();
	        $("#class-form").show();
