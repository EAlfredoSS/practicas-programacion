...
<style type="text/css">
	...
	* { box-sizing: border-box; }
	...
	.stat-icon {
		...
		border-radius: 6px;
		font-weight: 600;
		font-size: 11px;      /* reducido para 3 columnas */
	...
	.action-buttons {
		display: flex;
		flex-wrap: wrap;        /* wrap automático si no caben */
		gap: 6px;
		margin-top: auto;
		padding-top: 12px;
		width: 100%;
	...
	.btn-card {
		flex: 1 1 auto;         /* crece y encoge, hace wrap si es necesario */
		min-width: 0;
		display: inline-flex;
		align-items: center;
		justify-content: center;
		...
		line-height: 1.3;
		min-height: 34px;
		white-space: normal;    /* permite texto en 2 líneas */
	}
	...
	/* Texto largo del botón remove: se oculta en tarjetas pequeñas */
	.btn-text-long {
		display: inline;
	}
	...
	.btn-view-profile:hover {
		...
		box-shadow: 0 3px 8px rgba(149,165,166,0.35);
		text-decoration: none;
	}
	...
	@media (min-width: 992px) {
		...
		/* En 3 cols el espacio es justo: ocultamos texto largo del botón */
	...
	@media (min-width: 768px) and (max-width: 991px) {
		...
		/* En 2 cols hay más espacio: mostramos texto completo */
	...
	@media (max-width: 479px) {
		...
		/* En móvil muy pequeño los botones van en columna */
	...
	document.addEventListener('DOMContentLoaded', function () {
		document.querySelectorAll('.btn-remove-fav').forEach(button => {
			button.addEventListener('click', function (e) {
				...
				if (!confirm(`Are you sure you want to remove ${userName} from favourites?`)) return;
