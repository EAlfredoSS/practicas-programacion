                        ...
                        <div class="posts-section">
                            <div id="seccion_teach" class="post-bar">
                                ...
                                <div class="job_descp ">
									...
									if( ($level_idiomaofre1 == 0 AND !empty($idof1a)) OR  ($level_idiomaofre2 == 0 AND !empty($idof2a)) OR  ($level_idiomaofre3 == 0 AND !empty($idof3a)) )
									{ ?>  
                        ...
                        <div id="my_events" class="widget widget-jobs">
                            ...
                            <div class="jobs-list">
                                <div class="job-info">
                                    ...
                                    $query = "SELECT * FROM eventoslista WHERE unix_start_time>'$tiempo_corte' AND id_creador='$identificador2017' ORDER BY unix_start_time ASC";
                                    $result = mysqli_query($link, $query);
                                    ...
                                    ?>
                                        ...
                                        <div class="job-details sgt-text suggestion-usd">
											...
											<?php  echo "<a href=\"../events/makerecurrentshowinfo.php?idev=$id_event1\">Make weekly</a> ";        ?>
