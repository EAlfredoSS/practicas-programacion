...
$level_idiomaofre1=$fila['Idiomaof1_level'];
$level_idiomaofre2=$fila['Idiomaof2_level'];
$level_idiomaofre3=$fila['Idiomaof3_level'];

//die("nivel: $level_idiomaofre1 --- $level_idiomaofre2  ---  $level_idiomaofre3");
...
switch ($level_idiomaofre1) 
{
    case 0:
        $image_level_lang_ofr_1='no_data.png';
        break;
    case 1:
        $image_level_lang_ofr_1='zero_knowledge.png';
        break;
    case 2:
        $image_level_lang_ofr_1='a1.png';
        break;
	case 3:
        $image_level_lang_ofr_1='a2.png';
        break;
    case 4:
        $image_level_lang_ofr_1='b1.png';
        break;
    case 5:
        $image_level_lang_ofr_1='b2.png';
        break;
    case 6:
        $image_level_lang_ofr_1='c1.png';
        break;
    case 7:
        $image_level_lang_ofr_1='c2.png';
        break;
}


// escogemos la imagen del nivel del idioma 2
switch ($level_idiomaofre2) 
{
    case 0:
        $image_level_lang_ofr_2='no_data.png';
        break;
    case 1:
        $image_level_lang_ofr_2='zero_knowledge.png';
        break;
    case 2:
        $image_level_lang_ofr_2='a1.png';
        break;
	case 3:
        $image_level_lang_ofr_2='a2.png';
        break;
    case 4:
        $image_level_lang_ofr_2='b1.png';
        break;
    case 5:
        $image_level_lang_ofr_2='b2.png';
        break;
    case 6:
        $image_level_lang_ofr_2='c1.png';
        break;
    case 7:
        $image_level_lang_ofr_2='c2.png';
        break;
}


// escogemos la imagen del nivel del idioma 3
switch ($level_idiomaofre3) 
{
    case 0:
        $image_level_lang_ofr_3='no_data.png';
        break;
    case 1:
        $image_level_lang_ofr_3='zero_knowledge.png';
        break;
    case 2:
        $image_level_lang_ofr_3='a1.png';
        break;
	case 3:
        $image_level_lang_ofr_3='a2.png';
        break;
    case 4:
        $image_level_lang_ofr_3='b1.png';
        break;
    case 5:
        $image_level_lang_ofr_3='b2.png';
        break;
    case 6:
        $image_level_lang_ofr_3='c1.png';
        break;
    case 7:
        $image_level_lang_ofr_3='c2.png';
        break;
}
                        ...
                        <div class="posts-section">
                            <div id="seccion_teach" class="post-bar">
                                ...
                                <div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
									   ...
									   <?php if (!empty($idof1a)) { ?> 
												<li>
															...
															<a href="#" title="" style="text-align:center;"> <img class="language language-<?php echo  $idof1a; ?> " />
															
															</br>
															

																					<img style="margin-top: 5px; width: 50px; height: 5px;" src="./images/language_levels/<?php echo $image_level_lang_ofr_1; ?>" alt="<?php echo  $idiomas_nivel["$level_idiomaofre1"]; ?>" />

																		<br>   
																		 <?php echo  $idiomas_equiv["$idof1a"]; ?> (<?php echo  $idiomas_nivel["$level_idiomaofre1"];?>)
															</a>
											...
											<?php if (!empty($idof2a)) { ?> 
												<li>
															...
															<a href="#" title="" style="text-align:center;"> <img class="language language-<?php echo  $idof2a; ?> " />
															
															</br>
															

																					<img style="margin-top: 5px; width: 50px; height: 5px;" src="./images/language_levels/<?php echo $image_level_lang_ofr_2; ?>" alt="<?php echo  $idiomas_nivel["$level_idiomaofre2"]; ?>" />

																		<br>   
																		 <?php echo  $idiomas_equiv["$idof2a"]; ?> (<?php echo  $idiomas_nivel["$level_idiomaofre2"];?>)
															</a>
											...
											<?php if (!empty($idof3a)) { ?> 
												<li>
															...
															<a href="#" title="" style="text-align:center;"> <img class="language language-<?php echo  $idof3a; ?> " />
															
															</br>
															

																					<img style="margin-top: 5px; width: 50px; height: 5px;" src="./images/language_levels/<?php echo $image_level_lang_ofr_3; ?>" alt="<?php echo  $idiomas_nivel["$level_idiomaofre3"]; ?>" />

																		<br>   
																		 <?php echo  $idiomas_equiv["$idof3a"]; ?> (<?php echo  $idiomas_nivel["$level_idiomaofre3"];?>)
															</a>
									...
									<?php if( ($level_idiomaofre1 == 0 AND !empty($idof1a)) OR  ($level_idiomaofre2 == 0 AND !empty($idof2a)) OR  ($level_idiomaofre3 == 0 AND !empty($idof3a)) )
									{ ?>  
									
																				<br> <p style="font-size: 70%; color: #b2b2b2;">(*) This user didn't update his level of offered languages yet.</p>
                                ...
                                ?>
									...
									{ ?>
											...
											<br> <p style="font-size: 70%; color: #b2b2b2;">(*) This user didn't update his level of requested languages yet.</p>
