...
$query_my_langs = "SELECT * FROM my_langs WHERE id='$identificador2017' ORDER BY level_id DESC";
...
for($iii=0;$iii<count($my_langs_array);$iii++)
{
	...
	{
		$my_langs_typeofexchange_array[$iii]='I know this language and I want to exchange it for my another user\'s language (exchange free of cost).';
		$my_langs_priceorexchangetext_array[$iii]="For exchange";
	}
	else
	{
                                ...
                                <div class="job_descp ">
                                    ...
                                    <ul class="skill-tags">
											...
											?> 
												<li>
															<center>
																<a href="#" title="" style="text-align:center;"> <img class="language language-<?php echo  $idof; ?> " />
															...
															<div style="margin: -20px 0 0 0;" >			
																		<center>
																		 <?php echo  $idiomas_equiv["$idof"]; ?> (<?php echo  $idiomas_nivel["$level_idiomaofre"];?>)
																		 </center>
															</div>			 
															</a>
															...
															<div class="tooltip-container" style="font-size: 12px; color:#b2b2b2; margin: -5px 0 0 0; align: center;">
																	...
																	<span class="tooltip-text"><?php echo "$tooltip_ofr";	 ?></span>
