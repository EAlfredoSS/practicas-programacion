...
/*
$where_clause_student.=" AND (acos(sin(radians(Gpslat)) * sin(radians($latitud1)) + 
...
$organiz_id=array();
	...
	for($iiii=0; $iiii < $number_of_affected_users ; $iiii++     )
	{
		...
		//array_push($distancia111, $fila['distanciaPunto1Punto2']);
...
<div class='marco-fichas'>
	...
	<div class='ficha'>
		...
		<div><?php //echo "$distancia111 km from me"; ?></div>
