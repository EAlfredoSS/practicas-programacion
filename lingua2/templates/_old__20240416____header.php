    ...
    <div class="wrapper">
        ...
        <header>
            <div class="container">
                <div class="header-data">
                    ...
                    <div class="search-bar">
                        <form action="./u.php?">
                            <input type="text" name="identificador" placeholder="Search user by id (example: 4567)">
                        ...
                        <ul>
                            <li>
                                <a href="./partners.php" title="">
                                    <span><i class="far fa-address-card" aria-hidden="true" style="font-size: 18px;"></i></span>
                                    People search
			...
			$ur_new_msg = $ur_pm->getunreadmessages();  */
                            ...
                            <li>
                                <a href="../pms" title="">
                                    <span><i class="far fa-envelope" aria-hidden="true" style="font-size: 15px;"></i> </span>
                                    Mail (<?php echo $nuevos_emails; ?>)
                                </a>
                                <!-- <ul>
                            ...
                            <li>
                                <a href="../infouser/pendingactions.php" title="">
                                    ...
                                    Pending actions (<?php echo $nuevos_vote_total; ?>)
                                </a>
                            </li>
